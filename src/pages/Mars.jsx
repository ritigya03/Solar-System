...
function Mars() {
    return (
        <div className="relative min-h-screen overflow-hidden">
            ...
            <div className="absolute top-[220px] right-4 md:right-[90px] mg-top-[100px] lg:top-20 space-y-5 gap-5 flex md:block">
            ...
            <div className="absolute top-[300px] lg:top-[340px] md:top-[370px] left-4 md:top-[300px] sm:left-20 lg:left-[650px] w-[90%] max-w-[400px] h-auto">
