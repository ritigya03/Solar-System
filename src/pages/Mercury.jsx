...
function Mercury() {
    return (
        <div className="relative min-h-screen overflow-hidden">
            ...
            <img className='mt-9 absolute z-10  left-0 h-[200px] lg:h-[650px] animate-float mx-auto' src={MercuryImg} alt="" />
            ...
            <img className="absolute bottom-0 left-0 w-full h-full object-cover " src={stars} alt="Stars" />
        </div>
    );
}
