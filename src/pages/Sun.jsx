...
import card from '../assets/Frame 5.png';
...
function Sun() {
    return (
        <div className="relative min-h-screen overflow-hidden">
            ...
            <img className="absolute top-0 left-0 w-full h-auto md:h-[400px] animate-float" src={SunImg} alt="Sun" />
            <div className="absolute top-[200px] left-[20px] w-[90%] max-w-[700px] text-left md:top-[350px] md:left-[100px] md:w-[700px] md:text-left">
                ...
                <img className="mt-4 h-[80px] md:h-[100px] " src={card} alt="Card" />
            </div>
